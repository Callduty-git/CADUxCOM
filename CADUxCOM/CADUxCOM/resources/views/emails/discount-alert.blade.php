...
<head>
    ...
    <title>Gran descuento disponible</title>
    <style>
        body {
...
<body>
    <div class="header">
        ...
        <p>Hola {{ $user->name }}, tenemos una oferta especial para ti</p>
    </div>

    <div class="content">
        <h2>Producto con descuento especial</h2>
        ...
        <div class="product-card">
            ...
            <div class="discount-badge">
                -{{ round($discountPercentage, 0) }}% DESCUENTO
            </div>
            ...
            <div class="price-info">
                ...
                <p><strong>Ahorras:</strong> ${{ number_format($producto->PrecioOriginal - $producto->Precio, 2) }}</p>
            </div>
