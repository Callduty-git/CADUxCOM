...
<head>
    ...
    <title>Editar Regla de Descuento - CADUxCOM</title>
        ...
        <div class="discount-rules-container">
            ...
            <div class="page-header stacked">
                <div class="header-content">
                    <h1 class="page-title">Editar Regla de Descuento</h1>
                    <p class="page-subtitle">Actualiza la configuración de la regla de descuento progresivo</p>
                </div>
            ...
            <div class="form-container">
                <form action="{{ route('discount-rules.discount-rules.update', $discountRule->id) }}" method="POST" class="discount-form">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="form-grid">
                            <div class="form-group">
                                ...
                                <input type="text" id="name" name="name" class="form-input" 
                                       value="{{ old('name', $discountRule->name) }}" required placeholder="Ej: Descuento o regla de tales días">
                                @error('name')
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="description" name="description" class="form-textarea" 
                                          rows="3" placeholder="Ej: Describe brevemente la regla o descuento aplicado">{{ old('description', $discountRule->description) }}</textarea>
                                @error('description')
                                    <span class="form-error">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="form-grid">
                            <div class="form-group">
                                ...
                                <input type="number" id="days_before_expiry" name="days_before_expiry" 
                                       class="form-input" value="{{ old('days_before_expiry', $discountRule->days_before_expiry) }}" 
                            ...
                            <div class="form-group">
                                ...
                                <select id="discount_type" name="discount_type" class="form-select" required>
                                    ...
                                    <option value="percentage" {{ old('discount_type', $discountRule->discount_type) === 'percentage' ? 'selected' : '' }}>
                                        Porcentaje (%)
                                    </option>
                                    <option value="fixed_amount" {{ old('discount_type', $discountRule->discount_type) === 'fixed_amount' ? 'selected' : '' }}>
                                        Cantidad fija ($)
                                    </option>
                                </select>
                                @error('discount_type')
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" id="discount_value" name="discount_value" 
                                       class="form-input" value="{{ old('discount_value', $discountRule->discount_value) }}" 
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" id="minimum_product_price" name="minimum_product_price" 
                                       class="form-input" value="{{ old('minimum_product_price', $discountRule->minimum_product_price ?? 0) }}" 
                                       step="0.01" min="0">
                        ...
                        <div class="form-grid">
                            <div class="form-group">
                                ...
                                <input type="number" id="minimum_discount" name="minimum_discount" 
                                       class="form-input" value="{{ old('minimum_discount', $discountRule->minimum_discount ?? 0) }}" 
                                       step="0.01" min="0">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" id="maximum_discount" name="maximum_discount" 
                                       class="form-input" value="{{ old('maximum_discount', $discountRule->maximum_discount) }}" 
                                       step="0.01" min="0">
                        ...
                        <div class="form-grid">
                                    ...
                                    @foreach($categorias as $categoria)
                                        <div class="checkbox-item">
                                            <input type="checkbox" id="category_{{ $categoria->Id_Categoria }}" 
                                                   ...
                                                   {{ in_array($categoria->Id_Categoria, old('applicable_categories', $discountRule->applicable_categories ?? [])) ? 'checked' : '' }}>
                            ...
                            <div class="form-group">
                                ...
                                <div id="selected_products" class="selected-products">
                                    @php
                                        $selectedProducts = old('applicable_products', $discountRule->applicable_products ?? []);
                                    @endphp
                                    @foreach($selectedProducts as $productId)
                                        @php
                                            $productoSel = $productos->firstWhere('Id_Producto', $productId);
                                        @endphp
                                        @if($productoSel)
                                            <div class="selected-product">
                                                <span>{{ $productoSel->Nombre }} - {{ $productoSel->Marca }}</span>
                        ...
                        <div class="form-grid">
                            <div class="form-group">
                                ...
                                <div class="checkbox-item">
                                    ...
                                    <input type="checkbox" id="is_automatic" name="is_automatic" value="1"
                                           {{ old('is_automatic', $discountRule->is_automatic) ? 'checked' : '' }}>
                            ...
                            <div class="form-group">
                                ...
                                <input type="datetime-local" id="starts_at" name="starts_at" 
                                       class="form-input" value="{{ old('starts_at', optional($discountRule->starts_at)->format('Y-m-d\TH:i')) }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="datetime-local" id="expires_at" name="expires_at" 
                                       class="form-input" value="{{ old('expires_at', optional($discountRule->expires_at)->format('Y-m-d\TH:i')) }}">
